...
module SwiftApi
  # Defines an address.
  class Address
    # Address Line 1 | String(30) | Update Allowed.
    attr_accessor :address_line1

    # Address Line 2 | String(30) | Update Allowed.
    attr_accessor :address_line2

    # Suburb | String(30) | Update Allowed.
    attr_accessor :suburb

    # State | String(20) | Update Allowed.
    attr_accessor :state

    # Postcode | String(8) | Update Allowed.
    attr_accessor :postcode

    # Country | Complex Object | Update Allowed.
    ...
    def list_invalid_properties
      ...
      if @address_line2.nil?
        invalid_properties.push("invalid value for 'address_line2', address_line2 cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @address_line2.nil?
    ...
    def hash
      [address_line1, address_line2, suburb, state, postcode, country].hash
    end
