...
module SwiftApi
  # Defines a set of product descriptions.
  class Description
    # Description | String(60).
    attr_accessor :standard

    # Short Description | String(16).
    attr_accessor :short

    # Long Description | String(64).
    attr_accessor :long

    # Product Notes | String(no limit).
    attr_accessor :notes
    ...
    def list_invalid_properties
      ...
      if @short.nil?
        invalid_properties.push("invalid value for 'short', short cannot be nil.")
      end
    ...
    def hash
      [standard, short, long, notes].hash
    end
