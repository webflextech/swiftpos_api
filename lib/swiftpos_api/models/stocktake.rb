...
module SwiftApi
  # Defines a stocktake.
  class Stocktake
    # Gets or sets the stocktake reference number.
    attr_accessor :reference

    # Gets or sets the location id.
    attr_accessor :location_id

    # Gets or sets the id of the app used to create the stocktake.
    attr_accessor :app_id

    # Gets or sets the id of the device used to create the stocktake.
    attr_accessor :device_id

    # Gets or sets the stocktake items.
    attr_accessor :items
