...
module SwiftApi
  # Defines a country.
  class Country
    # Country Id | Int32 | Update Allowed.
    attr_accessor :id

    # Country Name | String | Update Denied.
    attr_accessor :name

    # ISO Country Code | String | Update Denied.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'IsoCountryCode')
        self.iso_country_code = attributes[:'IsoCountryCode']
      end
